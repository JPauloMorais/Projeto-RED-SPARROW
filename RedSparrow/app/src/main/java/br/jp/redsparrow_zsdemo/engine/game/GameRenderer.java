...
import br.jp.redsparrow_zsdemo.engine.util.FPSCounter;
import br.jp.redsparrow_zsdemo.engine.util.LogConfig;
import br.jp.redsparrow_zsdemo.engine.shaders.ColorShaderProg;
import br.jp.redsparrow_zsdemo.engine.shaders.ParticleShaderProg;
import br.jp.redsparrow_zsdemo.engine.shaders.TextureShaderProg;
...
public class GameRenderer extends GameSystem implements Renderer {
	...
	public ColorShaderProg colorShaderProg;
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
		...
		colorShaderProg = new ColorShaderProg(game.getContext());
