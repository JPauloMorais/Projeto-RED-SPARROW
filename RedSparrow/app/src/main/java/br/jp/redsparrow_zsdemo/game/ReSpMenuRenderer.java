...
import br.jp.redsparrow_zsdemo.engine.particles.ParticleSystem;
...
//	private int times = 0;
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		mEmitterWhite = new ParticleEmitter(new Vector3f(0,0,0), new Vector3f(0,0,5f), Color.WHITE, 360, 5);
