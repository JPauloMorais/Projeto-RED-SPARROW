...
//		Random r = new Random();
//
//		//Coloca tiles com sprites aleatorios pelo mapa
...
//				if(
//						mTilesLayer1[i][j].getX() < World.getPlayer().getX()+World.getRenderingRange().getX()+mTileSize/2 &&
//						mTilesLayer1[i][j].getX() > World.getPlayer().getX()-World.getRenderingRange().getX()-mTileSize/2 &&
//						mTilesLayer1[i][j].getY() < World.getPlayer().getY()+World.getRenderingRange().getY()+mTileSize/2 &&
//						mTilesLayer1[i][j].getY() > World.getPlayer().getY()-World.getRenderingRange().getY()-mTileSize/2
//						){
//
...
//			for (int j = 0; j < mHeightInTiles; j++) {
//				if(
//						mTilesLayer1[i][j].getX() < World.getPlayer().getX()+World.getRenderingRange().getX()+mTileSize &&
//						mTilesLayer1[i][j].getX() > World.getPlayer().getX()-World.getRenderingRange().getX()-mTileSize &&
//						mTilesLayer1[i][j].getY() < World.getPlayer().getY()+World.getRenderingRange().getY()+mTileSize &&
//						mTilesLayer1[i][j].getY() > World.getPlayer().getY()-World.getRenderingRange().getY()-mTileSize
//						){
//
